...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
  ...
  // Tu código:
  let xCinco = objetoMisterioso.numeroMisterioso * 5 ; 
  return xCinco ; 
}
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Tu código:
  let sumaLikes = 0;
  usuario.posts.forEach((persona)=>{sumaLikes =sumaLikes + persona.likes})
  return sumaLikes ;
}
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  return producto
  //return producto.prototype.calcularPrecioDescuento = ()=>{return precioConDescuento = producto.this.precio - ( producto.this.precio * producto.this.porcentajeDeDescuento)}
}
